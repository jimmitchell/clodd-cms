...
# Inter pinned in fonts/og/, so a system copy of Inter would never be read — this
# is only the first entry in OgImage::SYSTEM_FONTS, for the case where the pin has
